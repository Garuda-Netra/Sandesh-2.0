...
# Automatically trust Render external hostname if set
RENDER_EXTERNAL_HOSTNAME = os.environ.get('RENDER_EXTERNAL_HOSTNAME')
if RENDER_EXTERNAL_HOSTNAME:
    if RENDER_EXTERNAL_HOSTNAME not in ALLOWED_HOSTS:
        ALLOWED_HOSTS.append(RENDER_EXTERNAL_HOSTNAME)
else:
    # Local fallback or general wildcard
...
MIDDLEWARE = [
    ...
    'users.middleware.UserSessionTrackingMiddleware',
...
if _CLOUDINARY_CLOUD_NAME and _CLOUDINARY_API_KEY and _CLOUDINARY_API_SECRET:
    ...
    STORAGES = {
        'default': {
            'BACKEND': 'sdh.storage.SmartMediaCloudinaryStorage',
        },
        'staticfiles': {
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Sandesh Messenger <noreply@sandesh.com>')
